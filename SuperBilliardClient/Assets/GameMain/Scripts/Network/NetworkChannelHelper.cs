...
namespace SuperBilliard
{
    public class NetworkChannelHelper : INetworkChannelHelper
    {
        ...
        {
            m_NetworkChannel.Send(ReferencePool.Acquire<GameMessage.CSHeartBeat>());
            return true;
        }
        ...
        public IPacketHeader DeserializePacketHeader(Stream source, out object customErrorData)
        {
            ...
            {
                scHeader.flag = memoryStream.GetBuffer()[Constant.PacketConstant.PacketFlagIndex];
                scHeader.Id = BitConverter.ToUInt16(memoryStream.GetBuffer(), Constant.PacketConstant.PacketIdIndex);
                scHeader.PacketLength = BitConverter.ToUInt16(memoryStream.GetBuffer(), Constant.PacketConstant.PacketLengthIndex);
                return scHeader;
            }
            return null;
        }
