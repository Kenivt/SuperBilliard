...
namespace GameMessage
{
    ...
    public partial class SCAcceptGameInvitation : SCPacketBase
    {
        ...
        public static SCAcceptGameInvitation Create(GameType gameType, string inviterUsername, string ownUserName, InvitationResult result)
        {
    ...
    public partial class CSReadyGame : CSPacketBase
    {
        ...
        public static CSReadyGame Create(string username, bool isReady)
        {
            CSReadyGame packet = ReferencePool.Acquire<CSReadyGame>();
            packet.username_ = username;
